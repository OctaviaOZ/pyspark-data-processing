...
from src.utils import def_spark_session
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="PySpark Coding Challenge Data Pipeline")
...
if __name__ == "__main__":
    ...
    spark = None
    try:
        spark = def_spark_session("ZalandoCodingChallenge")
        main(spark, cli_args)
